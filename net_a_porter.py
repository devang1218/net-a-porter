...
url = 'https://drive.google.com/open?id=19r_vn0vuvHpE-rJpFHvXHlMvxa8UOeom'
...
def init_files(dump_path = 'dumps/netaporter_gb_similar.json'):
...
def prepare_dataset(path = 'dumps/netaporter_gb_similar.json'):
    product_json=[]
...
init_files('dumps/netaporter_gb_similar.json')

# PREPARING DATASET
df = prepare_dataset('dumps/netaporter_gb_similar.json')
